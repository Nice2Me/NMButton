...
- (void)viewDidLoad {
    ...
    UITextImageButton *button = [UITextImageButton buttonWithTitle:@"支付" image:[UIImage imageNamed:@"icon_arrows_gray_right"]];
    button.frame = CGRectMake(100, 100, 100, 100);
    [button setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
    [button setTitleImageType:kUITextImageButtonTypeLeftText];
    [self.view addSubview:button];
    
    UITextImageButton *button2 = [UITextImageButton buttonWithTitle:@"支付" image:[UIImage imageNamed:@"icon_arrows_gray_right"]];
    button2.frame = CGRectMake(100, 200, 100, 100);
    [button2 setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
    [button2 setTitleImageType:kUITextImageButtonTypeRightText];
    [self.view addSubview:button2];
    
    UITextImageButton *button3 = [UITextImageButton buttonWithTitle:@"支付" image:[UIImage imageNamed:@"icon_arrows_gray_right"]];
    ...
    UITextImageButton *button4 = [UITextImageButton buttonWithTitle:@"支付" image:[UIImage imageNamed:@"icon_arrows_gray_right"]];
